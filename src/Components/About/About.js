  ...
  <div>
    <blockquote>
      <p className={style.description}>
        ...
        help if you need. Ask us more questions if you did not understand the
        problem. You can reach us out at{" "}
        <a href="mailto:reachus@konfhub.com">reachus@konfhub.com</a>.
      </p>
    </blockquote>
